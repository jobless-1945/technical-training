package dsa.dataStructure.NonLinear.Trees.SegmentTree;

import java.util.Scanner;

public class SegmentTree {
    private static final int MAX_SIZE=10005;//Maximum size of the tree
    ...
    private static void build(int ind, int low, int high){
        ...
        seg[ind]=Math.max(seg[2*ind+1],seg[2*ind+2]);//segment
    }
